...
/// Web-specific implementation using package:web (WASM compatible)
Future<void> exportToDocImpl(PetitionModel data) async {
  ...
  final blob = web.Blob([content.toJS].toJS, web.BlobPropertyBag(type: 'application/msword'));
  final url = web.URL.createObjectURL(blob);
  
  final anchor = web.document.createElement('a') as web.HTMLAnchorElement;
  anchor.href = url;
  anchor.download = 'Petition_${DateTime.now().millisecondsSinceEpoch}.doc';
  anchor.click();
